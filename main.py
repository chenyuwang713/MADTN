...
parser.add_argument('--env_reset_interval', type=int, default=5000, help='Environment reset interval')
    ...
    with torch.no_grad():
        ...
        for _ in range(turns):
            ...
            while step < total_t:
                ...
                ep_r += info['service_aoi']  # Collect the service AOI as the reward
                s = s_prime
                step += 1
            scores += ep_r / total_t
    return scores/turns
